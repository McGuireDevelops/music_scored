        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {(profile?.role === "teacher" || profile?.role === "admin") && (
              <Link
                to="/teacher"
                className="rounded-xl inline-flex items-center gap-2 border border-gray-300 bg-white px-5 py-2.5 font-medium text-gray-700 no-underline transition-colors hover:bg-gray-50"
              >
                Teaching
              </Link>
            )}
